...
async function updateBtcData() {
    try {
        ...
        // Try to read existing data.js to preserve other data
        if (fs.existsSync('data.js')) {
            ...
            // If data.js doesn't exist, add empty placeholders
            newContent += 'const mnavHistoricalData = [];\n\n';
            newContent += 'const strHistoricalData = {};\n\n';
        }
